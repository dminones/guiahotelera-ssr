...
import { getRandomImage, getDestinations, getHomeDestinations, getItems } from '../data';
    ...
    return (
      <Layout site={this.props.site}>
        ...
        <Destinations page={6}
          ...
          style={{ backgroundColor: "#f8f8f8", borderBottom: '1px solid #e8e8e8' }} />
        <Items
